...
export function SupervisorProfile({
  ...
  const handleSave = async () => {
    if (!form.nombre || !form.correo || !form.telefono || !form.apellido) {
  ...
  const handleChangePassword = async () => {
    ...
    try {
      ...
      // Detectar tipo de error y asignar al campo correspondiente
      if (
          ...
          <div className="p-5 space-y-5">
            ...
            <section>
              ...
              <div className="bg-muted p-3 rounded text-sm space-y-1">
                <p>
                  <b>Nombre:</b> {data.empresa?.nombre}
                </p>
                <p>
                  <b>RUC:</b> {data.empresa?.ruc}
                </p>
                <p>
                  <b>Dirección:</b> {data.empresa?.direccion}
                </p>
                <p>
                  <b>Teléfono:</b> {data.empresa?.telefono}
                </p>
              </div>
            </section>
